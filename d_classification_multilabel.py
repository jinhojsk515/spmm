...
import datetime
from dataset import SMILESDataset_Clintox, SMILESDataset_SIDER
...
def main(args, config):
    ...
    name = args.name
    if name == 'clintox':
        dataset_train = SMILESDataset_Clintox('data/4_MoleculeNet/Clintox_train.csv')
        dataset_val = SMILESDataset_Clintox('data/4_MoleculeNet/Clintox_valid.csv')
        dataset_test = SMILESDataset_Clintox('data/4_MoleculeNet/Clintox_test.csv')
    elif name == 'sider':
        dataset_train = SMILESDataset_SIDER('data/4_MoleculeNet/SIDER_train.csv')
        dataset_val = SMILESDataset_SIDER('data/4_MoleculeNet/SIDER_valid.csv')
        dataset_test = SMILESDataset_SIDER('data/4_MoleculeNet/SIDER_test.csv')
    else:
        print('Dataset not found', name)
    print(len(dataset_train), len(dataset_val), len(dataset_test))
    train_loader = DataLoader(dataset_train, batch_size=config['batch_size_train'], num_workers=8, pin_memory=True, drop_last=False)
